...
var MyApp = (function () {
    ...
    MyApp.prototype.presentToast = function (m, clss) {
        if (m === void 0) { m = ''; }
        if (clss === void 0) { clss = ''; }
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"D:\mobile\RideDriver\src\app\app.html"*/'<ion-menu [content]="content">\n\n  <ion-header>\n\n    <ion-toolbar>\n\n      <ion-title>Menu</ion-title>\n\n    </ion-toolbar>\n\n  </ion-header>\n\n\n\n  <ion-content>\n\n    <ion-list>\n\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n\n        {{p.title}}\n\n      </button>\n\n    </ion-list>\n\n  </ion-content>\n\n\n\n</ion-menu>\n\n\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"D:\mobile\RideDriver\src\app\app.html"*/
        }),
...
var HomePage = (function () {
    function HomePage(navCtrl, geolocation, storage, inj) {
        this.navCtrl = navCtrl;
        this.geolocation = geolocation;
        this.storage = storage;
        this.inj = inj;
        this.active_driver = false;
        this.apiKey = 'AIzaSyA9f8YjPIgwAr-ZIscN1nTMmGUZsDsHbTQ';
    ...
    HomePage.prototype.ActiveDrive = function () {
        var _this = this;
        this.storage.get('active_driver').then(function (val) {
            _this.active_driver = val;
        });
    };
    HomePage.prototype.UpdateStatus = function () {
        var _this = this;
        this.storage.set('active_driver', this.active_driver).then(function (val) {
            if (_this.active_driver) {
                _this.MainApp.presentToast('Your service are turn on.', 'toggle');
            }
            else {
                _this.MainApp.presentToast('Your service are turn off.', 'toggle');
            }
        });
    };
...
var ListPage = (function () {
    ...
    ListPage = ListPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-list',template:/*ion-inline-start:"D:\mobile\RideDriver\src\pages\list\list.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>List</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n  <ion-list>\n\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n\n      <ion-icon [name]="item.icon" item-start></ion-icon>\n\n      {{item.title}}\n\n      <div class="item-note" item-end>\n\n        {{item.note}}\n\n      </div>\n\n    </button>\n\n  </ion-list>\n\n  <div *ngIf="selectedItem" padding>\n\n    You navigated here from <b>{{selectedItem.title}}</b>\n\n  </div>\n\n</ion-content>\n\n'/*ion-inline-end:"D:\mobile\RideDriver\src\pages\list\list.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_storage__ = __webpack_require__(197);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
